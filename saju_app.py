...
## 재물운
재성(정재·편재)의 유무·강약과 대운·세운의 재물 흐름을 짧게. 위 [대운표]에서 **현재 나이 이후 가까운 대운 2~3개(약 20~30년, 사회 활동이 활발한 범위)** 안에서만 재성이 뚜렷하게 들어오거나 강해지는 시기를 찾아 "몇 세부터(어떤 대운) 재물운이 특히 좋아진다"처럼 구체적으로 짚어주십시오. 그 범위 안에 뚜렷한 시기가 없으면 억지로 만들지 말고 이 언급은 생략하고 현재 흐름만 짧게 쓰십시오. 이미 현재 나이가 많아 그 범위 안에 활동적인 대운이 남아있지 않다면, 미래 예측 대신 현재 대운의 흐름 위주로 설명하십시오.

## 직업·적성
[직업유형 참고표]에서 이 사주의 십성 조합과 가장 가깝게 일치하는 직업 1~3개만 골라 짧게 제시. 참고표에 정확히 맞는 게 없으면 십성 특성 기반으로 일반적 적성만.

## 대인관계
비겁·도화 등 대인관계 관련 신살·십성을 짧게. {gender_label}성 배우자성({spouse_star})도 이 항목에서 함께. 위 [대운표]에서 **현재 나이 이후 가까운 대운 2~3개(약 20~30년, 사회 활동이 활발한 범위)** 안에서만 배우자성({spouse_star})이나 도화가 뚜렷하게 들어오거나 강해지는 시기를 찾아 "몇 세부터(어떤 대운) 애정운/이성운이 특히 좋아진다"처럼 구체적으로 짚어주십시오. 그 범위 안에 뚜렷한 시기가 없으면 억지로 만들지 말고 이 언급은 생략하고 현재 흐름만 짧게 쓰십시오. 이미 현재 나이가 많아 그 범위 안에 활동적인 대운이 남아있지 않다면, 미래 예측 대신 현재 대운의 흐름 위주로 설명하십시오.
