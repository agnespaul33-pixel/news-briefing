...
## 재물운
재성(정재·편재)의 유무·강약과 대운·세운의 재물 흐름을 짧게. 위 [대운표]를 훑어 재성이 들어오거나 강해지는 대운 나이대를 찾아 "몇 세부터(어떤 대운) 재물운이 특히 좋아진다"처럼 구체적 시기를 반드시 짚어주십시오. 마땅한 시기가 없으면 현재 흐름만 짧게.

## 직업·적성
[직업유형 참고표]에서 이 사주의 십성 조합과 가장 가깝게 일치하는 직업 1~3개만 골라 짧게 제시. 참고표에 정확히 맞는 게 없으면 십성 특성 기반으로 일반적 적성만.

## 대인관계
비겁·도화 등 대인관계 관련 신살·십성을 짧게. {gender_label}성 배우자성({spouse_star})도 이 항목에서 함께. 위 [대운표]를 훑어 배우자성({spouse_star})이나 도화가 들어오거나 강해지는 대운 나이대를 찾아 "몇 세부터(어떤 대운) 애정운/이성운이 특히 좋아진다"처럼 구체적 시기를 반드시 짚어주십시오. 마땅한 시기가 없으면 현재 흐름만 짧게.
