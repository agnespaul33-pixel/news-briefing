...
## 재물운
재성(정재·편재)의 유무·강약과 대운·세운의 재물 흐름을 짧게. 위 [대운표]에서 **현재 나이부터 60세까지**의 대운만 살펴 재성이 들어오거나 강해지는 시기를 찾아 "몇 세부터(어떤 대운) 재물운이 특히 좋아진다"처럼 구체적 시기를 짚어주십시오. 60세는 활동력이 크게 꺾이는 현실적 기준선이니, 61세 이후 대운은 언급하지 마십시오. 60세 이전에 마땅한 시기가 없으면 무리해서 찾지 말고 현재 흐름만 짧게.

## 직업·적성
[직업유형 참고표]에서 이 사주의 십성 조합과 가장 가깝게 일치하는 직업 1~3개만 골라 짧게 제시. 참고표에 정확히 맞는 게 없으면 십성 특성 기반으로 일반적 적성만.

## 대인관계
비겁·도화 등 대인관계 관련 신살·십성을 짧게. {gender_label}성 배우자성({spouse_star})도 이 항목에서 함께. 위 [대운표]에서 **현재 나이부터 60세까지**의 대운만 살펴 배우자성({spouse_star})이나 도화가 들어오거나 강해지는 시기를 찾아 "몇 세부터(어떤 대운) 애정운/이성운이 특히 좋아진다"처럼 구체적 시기를 짚어주십시오. 60세는 사회 활동과 대인관계가 크게 줄어드는 현실적 기준선이니, 61세 이후 대운은 언급하지 마십시오. 60세 이전에 마땅한 시기가 없으면 무리해서 찾지 말고 현재 흐름만 짧게.
